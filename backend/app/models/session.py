...
from sqlalchemy import String, Integer, BigInteger, Text, DateTime, ForeignKey, Numeric, func
...
class AnalysisSession(Base):
    ...
    analysis_plan: Mapped[dict | None] = mapped_column(JSONB, nullable=True)
